...
const DisplayCitiesQuickPossessions = ({ data }) => {
  ...
  if (!data.displayCitiesQuickPossessions) {
    return null
  } else {
    return (
      <StyledSection>
            ...
            {sortedCities.map((city, index) => {
              return (
                <div className="cities-links-city" key={index}>
                  <a href={city.node.CityContent.quickPossessionsPageLink.uri}>
...
export default DisplayCitiesQuickPossessions
